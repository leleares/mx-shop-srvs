...
import (
	...
	"mx-shop-srvs/user_interaction_srv/handler"
	"mx-shop-srvs/user_interaction_srv/initialize"
	"mx-shop-srvs/user_interaction_srv/proto"
	"mx-shop-srvs/user_interaction_srv/utils"
	"mx-shop-srvs/user_interaction_srv/utils/register/consul"
	"net"
	"os"
	"os/signal"
	"syscall"
