...
type OrderClient interface {
	...
	CreateCartItem(ctx context.Context, in *CartItemRequest, opts ...grpc.CallOption) (*ShoppingCartInfoResponse, error)
...
func (c *orderClient) CreateCartItem(ctx context.Context, in *CartItemRequest, opts ...grpc.CallOption) (*ShoppingCartInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShoppingCartInfoResponse)
...
type OrderServer interface {
	...
	CreateCartItem(context.Context, *CartItemRequest) (*ShoppingCartInfoResponse, error)
...
func (UnimplementedOrderServer) CreateCartItem(context.Context, *CartItemRequest) (*ShoppingCartInfoResponse, error) {
